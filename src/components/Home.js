...
import heroImage from '../assests/images/robot.png'
        ...
        <div className="row g-5 py-5">
            <div className="col-lg-7 align-self-center text-center text-lg-start mb-lg-5 p-r">
                <div className="pt-lg-5 pb-lg-5">
                    <a className="#" class="btn btn-sm border rounded-pill text-white px-3 mb-3 animated slideInRight">TechVibe</a>
                    ...
                    <div className="d-flex banner-btn">
                        ...
                        <Link to="/contact" className="btn btn-primary-outline py-sm-3 px-sm-5 rounded-pill" tittle="Contact Us">Contact Us</Link>
                    </div>
                </div>
            </div>
